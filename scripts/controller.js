import {LinenShirt, LinenPants, Dagger, BlacksmithHammer, Spear, Shortsword, Longsword, Handaxe, WarHammer, NightbladeSword,
    ...
    ThrowingKnife, PoisonedKnife, Meteorite, Antidote, AloeRemedy, Net, SmokeBomb, Hide, Bandage, FrostbiteTonic, ParalysisTonic, PineWood, TigerClaw, DogPaw, HawkTalons, RoyalAltusRobes, RoyalAltusPants, PowerRing, Katana, Katana2, Katana3, Katana4
    } from "./items.js";
    ...
    characterCreatorDetermineUpdateStats(){
        ...
        switch(value){
            ...
            case "blacksmith":
                ...
                break;
            case "ranger":
                this.characterCreatorUpdateStats(5, 8, 5, 5, 3, 400);
                break;
            case "scholar":
