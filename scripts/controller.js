import {LinenShirt, LinenPants, Dagger, BlacksmithHammer, Spear, Shortsword, Longsword, Handaxe, WarHammer, NightbladeSword,
    ...
    ThrowingKnife, PoisonedKnife, Meteorite, Antidote, AloeRemedy, Net, SmokeBomb, Hide, Bandage, FrostbiteTonic, ParalysisTonic, PineWood, TigerClaw, DogPaw, HawkTalons, RoyalAltusRobes, RoyalAltusPants, PowerRing, Katana, Katana2, Katana3, Katana4, SkullRing, Chain
    } from "./items.js";
    ...
    characterCreatorUpdateInventory(){
        ...
        switch(value){
            ...
            case "warrior":
                ...
                break;
            case "thief":
                equippedArray.push(new Dagger, new Shiv, new LeatherHood, new RoyalAltusRobes, new SkullRing, new LinenPants, new LeatherBoots);
